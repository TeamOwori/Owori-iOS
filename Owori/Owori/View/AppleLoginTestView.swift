...
struct AppleLoginTestView: View {
    var appleLoginViewModel: AppleLoginTestViewModel = AppleLoginTestViewModel()
    ...
    var body: some View {
        VStack {
            appleLoginViewModel.appleLoginButton()
            Button {
                userViewModel.joinMember(socialToken: appleLoginViewModel.socialToken)
            } label: {
                Text("Create User")
            }
            Button {
