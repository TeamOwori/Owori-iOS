        ...
        VStack {
            ...
            storyViewModel.updateStory(user: userViewModel.user, storyInfo: [
                "story_id" : "\(storyViewModel.testStoryId)",
                  ...
                  "title" : "기다리고 기다리던 하루",
                  "content" : "종강하면 동해바다로 가족 여행 가자고 한게 엊그제 같았는데...3박 4일 동해여행 너무 재밌었어!! 날씨도 너무 좋았고 특히 갈치조림이 대박 ㄹㅇ 맛집 인정... 2일차 점심 때 대림공원 안에서 피크닉한게 가장 기억에 남았던거 같아! 엄마가 만들어 준 샌드위치는 세상에서 젤 맛있어 이거 팔면 대박날듯 ㅋㅋㅋ ",
                  "images_id" : [ "2775c5d0-a457-4f2d-b2aa-a83f5deec104", "2449adfe-a2ac-4379-93d2-fe0985a15ed4", "d717353c-c2fb-4c68-ad2c-ebdc1cd3666f", "382b6433-9271-4a05-84ec-f00ecd25dfb7", "5298a6ba-bc8a-4c1b-8654-74a889bed252", "2abef78d-f2a9-4bca-9265-773baa53ea83" ]
            ])
        } label: {
            Text("Update Story")
        }
