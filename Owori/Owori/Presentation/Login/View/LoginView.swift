...
struct LoginView: View {
    let test1: [SocialLoginStyle] = [SocialLoginStyle(id: UUID(), buttonImage: ImageResource.kakaoLogin), SocialLoginStyle(id: UUID(), buttonImage: ImageResource.appleLogin)]
