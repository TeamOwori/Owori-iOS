        ...
        ScrollView {
            VStack(spacing: 0) {
                ...
                VStack(spacing: 0) {
                    ...
                    DetailContent(isFavorite: $isFavorite, storyInfo: $storyInfo, stories: $stories, storiesForCollection: $storiesForCollection, storyDetailViewIsActive: $storyDetailViewIsActive, storyDetailViewIsActiveFromStoryAlbum: $storyDetailViewIsActiveFromStoryAlbum)
                }
